...
const EditListing = () => {
  ...
  useEffect(() => {
    console.log('useFeefect这里的 Form instance:', form);
    console.log('useFeefect这里的 Initial form values:', form.getFieldsValue());
  ...
  return (
    <div>
      ...
      >
        ...
        <Form.Item>
          <Button type="primary" htmlType="submit" onClick={on}>
            Save
          </Button>
