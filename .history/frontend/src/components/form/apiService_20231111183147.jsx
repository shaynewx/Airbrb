...
export const updateListing = (listingId, listingDetails) => {
  // console.log('正在更新ID为:', listingId, '的房源');
  // console.log('请求有效负载:', listingDetails);
  return put(`${BASE_URL}/listings/${listingId}`, listingDetails, true);
};
