...
const CreateNewListing = () => {
  ...
  const apiPOST = (values) => {
    ...
    delete metadata.images; // Assuming 'images' field is included in the form values.

    const dataToSubmit = {
      title: values.title,
      address: values.address, // Adjust this if the backend expects a more structured object.
      price: values.price,
      thumbnail: thumbnailBase64,
      images: imagesBase64, // Includes all images as Base64 strings.
      metadata: metadata
    };
    };
