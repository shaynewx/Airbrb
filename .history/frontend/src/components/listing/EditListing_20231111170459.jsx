...
const EditListing = () => {
  ...
  const handleThumbnailChange = ({ fileList }) => {
    // Update the form field to reflect the current fileList
      ...
      >
        ...
        >
          <Upload
            ...
            onPreview={handlePreview} // you might need to define a function to handle preview if needed
            onChange={handleThumbnailChange}
            onRemove={(file) => {
              // Handle the removal here. You can update the state or form values.
            }}
          >
            {form.getFieldValue('thumbnail').length >= 1 ? null : uploadButton}
          </Upload>
        </Form.Item>
